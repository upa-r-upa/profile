    ...
    <Wrapper>
      ...
      <ContentSection>
        ...
        <Card>
          ...
          <p>
            혼자서 백엔드부터 프론트엔드까지 하려니까 시간이 배로 걸리는 것 같습니다. 그렇지만 원하는 서비스가 내 손에서
            완성되는 모습을 보는게 너무 즐겁습니다.
          </p>
          <p>얼른 더 많은 사용자가 생겨서 유용한 서비스가 되고 싶습니다.</p>
        </Card>
        ...
        <Card>
          ...
          <p>생각만큼 자주 올리진 못하지만 블로그도 꾸준히 올리고자 합니다.</p>
        </Card>
        ...
        <Card>
          <Title>연락</Title>
          <p>
            <a href="mailto:me@upa-r-upa.com">me@upa-r-upa.com</a>
          </p>
          <p>
            <a href="https://github.com/upa-r-upa">Go to Rupa Github</a>
          </p>
        </Card>
      </ContentSection>
    </Wrapper>
